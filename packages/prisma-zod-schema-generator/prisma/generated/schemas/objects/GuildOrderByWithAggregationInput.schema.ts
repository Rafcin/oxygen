...
import { GuildAvgOrderByAggregateInputObjectSchema } from './GuildAvgOrderByAggregateInput.schema';
...
import { GuildSumOrderByAggregateInputObjectSchema } from './GuildSumOrderByAggregateInput.schema';
...
const Schema: z.ZodType<Prisma.GuildOrderByWithAggregationInput> = z
  .object({
    ...
    _count: z
      .lazy(() => GuildCountOrderByAggregateInputObjectSchema)
      .optional(),
    _avg: z.lazy(() => GuildAvgOrderByAggregateInputObjectSchema).optional(),
    ...
    _sum: z.lazy(() => GuildSumOrderByAggregateInputObjectSchema).optional(),
  })
  .strict();
