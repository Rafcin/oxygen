...
const Schema: z.ZodType<Prisma.GuildUncheckedCreateNestedManyWithoutUsersInput> =
  z
    .object({
      create: z
        .union([
          ...
          z
            .lazy(() => GuildUncheckedCreateWithoutUsersInputObjectSchema)
            .array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          ...
          z
            .lazy(() => GuildCreateOrConnectWithoutUsersInputObjectSchema)
            .array(),
        ])
        .optional(),
      connect: z
...
export const GuildUncheckedCreateNestedManyWithoutUsersInputObjectSchema =
  Schema;
