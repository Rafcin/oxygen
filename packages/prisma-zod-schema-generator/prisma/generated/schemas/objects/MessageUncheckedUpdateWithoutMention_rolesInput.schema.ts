...
import { ReactionUncheckedUpdateManyWithoutMessagesNestedInputObjectSchema } from './ReactionUncheckedUpdateManyWithoutMessagesNestedInput.schema';
...
const Schema: z.ZodType<Prisma.MessageUncheckedUpdateWithoutMention_rolesInput> =
  z
    .object({
      thread: z
        .union([
      ...
      reactions: z
        .lazy(
          () =>
            ReactionUncheckedUpdateManyWithoutMessagesNestedInputObjectSchema,
        )
        .optional(),
      reactionIds: z
        .union([
      ...
      users: z
        .lazy(
          () => UserUncheckedUpdateManyWithoutMessagesNestedInputObjectSchema,
        )
        .optional(),
      userIds: z
        .union([
...
export const MessageUncheckedUpdateWithoutMention_rolesInputObjectSchema =
  Schema;
