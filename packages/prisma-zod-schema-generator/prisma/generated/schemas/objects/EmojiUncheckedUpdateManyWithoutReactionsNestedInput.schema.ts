...
const Schema: z.ZodType<Prisma.EmojiUncheckedUpdateManyWithoutReactionsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => EmojiUpdateManyWithWhereWithoutReactionsInputObjectSchema,
          ),
          z
            .lazy(
              () => EmojiUpdateManyWithWhereWithoutReactionsInputObjectSchema,
...
export const EmojiUncheckedUpdateManyWithoutReactionsNestedInputObjectSchema =
  Schema;
