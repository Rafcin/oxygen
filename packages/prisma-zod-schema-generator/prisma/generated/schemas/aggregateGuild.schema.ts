...
import { GuildAvgAggregateInputObjectSchema } from './objects/GuildAvgAggregateInput.schema';
import { GuildSumAggregateInputObjectSchema } from './objects/GuildSumAggregateInput.schema';
...
export const GuildAggregateSchema = z.object({
  ...
  _avg: GuildAvgAggregateInputObjectSchema.optional(),
  _sum: GuildSumAggregateInputObjectSchema.optional(),
});
