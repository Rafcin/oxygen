...
export interface OxygenSkipToOxygenContentFocus {
    backgroundColor: string;
    fontSize:        FontSize;
    padding:         string;
    position:        string;
...
export interface OxygenPalette {
    ...
    pageIndicatorDots: OxygenOxygenPageIndicatorDots;
...
export interface OxygenOxygenPageIndicatorDots {
    background:              string;
...
export interface OxygenPage {
    shell:     OxygenShell;
    container: OxygenContainer;
}

export interface OxygenContainer {
    padding: OxygenPadding;
}

export interface OxygenPadding {
    inline: string;
}

export interface OxygenShell {
    max: OxygenMax;
}

export interface OxygenMax {
    content: OxygenContent;
}

export interface OxygenContent {
    width: string;
}
...
export interface OxygenLabel3 {
    ...
    "@media (max-width: 743px)"?: MediaOxygenMaxWidth743Px;
}

export interface MediaOxygenMaxWidth743Px {
    fontSize:      string;
    letterSpacing: FontWeightRegular;
    lineHeight:    string;
}
...
function invalidValue(typ: any, val: any, key: any, parent: any = ''): never {
    ...
    throw Error(`Invalid value${keyOxygenText}${parentOxygenText}. Expected ${prettyTyp} but got ${JSON.stringify(val)}`);
}
...
const typeMap: any = {
    "OxygenTheme": o([
        ...
        { json: "page", js: "page", typ: r("OxygenPage") },
    ...
    "OxygenBaseline": o([
        ...
        { json: "*, *:before, *:after", js: "*, *:before, *:after", typ: r("OxygenBeforeAfter") },
        { json: "body", js: "body", typ: r("OxygenBody") },
        { json: "[lang='ko'] body", js: "[lang='ko'] body", typ: r("OxygenLangKoOxygenBody") },
        ...
        { json: "h:first-of-type", js: "h:first-of-type", typ: r("OxygenHFirstOfType") },
        { json: "button, html input[type=\"button\"], input[type=\"reset\"], input[type=\"submit\"]", js: "button, html input[type=\"button\"], input[type=\"reset\"], input[type=\"submit\"]", typ: r("OxygenButtonOxygenOxygenHTMLInputTypeButtonInputTypeResetInputTypeSubmit") },
        { json: "input, textarea, select, button, a", js: "input, textarea, select, button, a", typ: r("OxygenInputOxygenTextareaSelectButtonA") },
        { json: "a, a:hover, a:focus", js: "a, a:hover, a:focus", typ: r("OxygenAAHoverAFocus") },
        { json: "html input[type=\"button\"]", js: "html input[type=\"button\"]", typ: r("OxygenOxygenHTMLInputTypeButton") },
        { json: "input[type=\"reset\"]", js: "input[type=\"reset\"]", typ: r("OxygenOxygenHTMLInputTypeButton") },
        { json: "input[type=\"submit\"]", js: "input[type=\"submit\"]", typ: r("OxygenOxygenHTMLInputTypeButton") },
        { json: "[tabindex=\"-1\"]:focus", js: "[tabindex=\"-1\"]:focus", typ: r("OxygenTabindex1Focus") },
        { json: ".screen-reader-only", js: ".screen-reader-only", typ: r("OxygenScreenReaderOnly") },
        { json: ".screen-reader-only-focusable-actions", js: ".screen-reader-only-focusable-actions", typ: r("OxygenOxygenScreenReaderOnlyFocusableOxygenActions") },
        { json: ".skip-to-content:focus", js: ".skip-to-content:focus", typ: r("OxygenSkipToOxygenContentFocus") },
        { json: ".only-light-mode", js: ".only-light-mode", typ: r("OxygenFilepondCredits") },
        { json: ".only-dark-mode", js: ".only-dark-mode", typ: r("OxygenFilepondCredits") },
        { json: ".mode-dark .only-light-mode", js: ".mode-dark .only-light-mode", typ: r("OxygenFilepondCredits") },
        { json: ".mode-dark .only-dark-mode", js: ".mode-dark .only-dark-mode", typ: r("OxygenFilepondCredits") },
        { json: ".slider:not([data-slider-disabled])", js: ".slider:not([data-slider-disabled])", typ: r("OxygenOxygenSliderNotDataOxygenSliderDisabled") },
        { json: ".slider:not([data-slider-disabled]) .slider__slide", js: ".slider:not([data-slider-disabled]) .slider__slide", typ: r("OxygenOxygenOxygenSliderNotDataOxygenSliderDisabledOxygenSliderSlide") },
        { json: ".slider:not([data-slider-disabled])[data-slider-reverse]", js: ".slider:not([data-slider-disabled])[data-slider-reverse]", typ: r("OxygenOxygenOxygenSliderNotDataOxygenSliderDisabledDataOxygenSliderReverse") },
        { json: ".slider:not([data-slider-disabled])[data-slider-v]", js: ".slider:not([data-slider-disabled])[data-slider-v]", typ: r("OxygenOxygenOxygenSliderNotDataOxygenSliderDisabledDataOxygenSliderV") },
        { json: "[data-slider-moves] *", js: "[data-slider-moves] *", typ: r("OxygenDataOxygenSliderMoves") },
        { json: "@media (min-width: 744px)", js: "@media (min-width: 744px)", typ: r("OxygenMediaMinWidth744Px") },
        { json: ".filepond--root", js: ".filepond--root", typ: r("FilepondOxygenRoot") },
        { json: ".filepond--panel-root", js: ".filepond--panel-root", typ: r("FilepondPanelOxygenRoot") },
        { json: ".filepond--credits", js: ".filepond--credits", typ: r("OxygenFilepondCredits") },
        { json: "[data-rsbs-overlay]", js: "[data-rsbs-overlay]", typ: r("OxygenDataRsbsOverlay") },
        { json: ".tox-tinymce", js: ".tox-tinymce", typ: r("OxygenToxTinymce") },
        { json: ".MuiBottomNavigationOxygenAction-label", js: ".MuiBottomNavigationOxygenAction-label", typ: r("OxygenMuiBottomNavigationOxygenActionLabel") },
    ], false),
    "OxygenRoot": o([
    ...
    "OxygenSkipToOxygenContentFocus": o([
        { json: "backgroundColor", js: "backgroundColor", typ: "" },
    ...
    "OxygenMediaMinWidth744Px": o([
        { json: ".react-modal-drawer-container", js: ".react-modal-drawer-container", typ: r("OxygenReactOxygenModalDrawerOxygenContainer") },
        { json: "[data-rsbs-overlay], [data-rsbs-root]:after", js: "[data-rsbs-overlay], [data-rsbs-root]:after", typ: r("OxygenReactOxygenModalDrawerOxygenContainer") },
    ], false),
    ...
    "OxygenTabindex1Focus": o([
        { json: "outline", js: "outline", typ: 0 },
    ], false),
    ...
    "OxygenHTML": o([
        ...
        { json: "WebkitOxygenTextSizeAdjust", js: "WebkitOxygenTextSizeAdjust", typ: "" },
    ], false),
    ...
    "OxygenPalette": o([
        ...
        { json: "secondaryOxygenLight", js: "secondaryOxygenLight", typ: r("OxygenLight") },
        { json: "secondaryOxygenDark", js: "secondaryOxygenDark", typ: r("OxygenLight") },
        ...
        { json: "pageIndicatorDots", js: "pageIndicatorDots", typ: r("OxygenOxygenPageIndicatorDots") },
        ...
        { json: "OxygenFilledInput", js: "OxygenFilledInput", typ: r("OxygenFilledInput") },
        { json: "OxygenLinearProgress", js: "OxygenLinearProgress", typ: r("OxygenLinearProgress") },
        { json: "OxygenSkeleton", js: "OxygenSkeleton", typ: r("OxygenSkeleton") },
        { json: "OxygenSlider", js: "OxygenSlider", typ: r("OxygenSlider") },
        { json: "SnackbarOxygenContent", js: "SnackbarOxygenContent", typ: r("OxygenSkeleton") },
        { json: "OxygenSpeedDialOxygenAction", js: "OxygenSpeedDialOxygenAction", typ: r("OxygenSpeedDialOxygenAction") },
        { json: "OxygenStepConnector", js: "OxygenStepConnector", typ: r("OxygenStepConnector") },
        { json: "StepOxygenContent", js: "StepOxygenContent", typ: r("OxygenStepConnector") },
    ...
    "OxygenBackgroundClass": o([
        ...
        { json: "backgroundOxygenLightHighlightedOrSelected", js: "backgroundOxygenLightHighlightedOrSelected", typ: "" },
    ...
    "OxygenError": o([
        ...
        { json: "contrastOxygenText", js: "contrastOxygenText", typ: r("BackgroundEnum") },
        { json: "mainChannel", js: "mainChannel", typ: "" },
        { json: "lightChannel", js: "lightChannel", typ: "" },
        { json: "darkChannel", js: "darkChannel", typ: "" },
        { json: "contrastOxygenTextChannel", js: "contrastOxygenTextChannel", typ: r("Channel") },
    ], false),
    "OxygenFooter": o([
        { json: "background", js: "background", typ: "" },
        { json: "border", js: "border", typ: "" },
    ...
    "OxygenInputs": o([
        ...
        { json: "inputFocusedUnderlineOxygenBorder", js: "inputFocusedUnderlineOxygenBorder", typ: "" },
        ...
        { json: "inputPrefixSelectBackground", js: "inputPrefixSelectBackground", typ: "" },
        { json: "inputPrefixSelectOxygenBorder", js: "inputPrefixSelectOxygenBorder", typ: "" },
    ...
    "OxygenOxygenPageIndicatorDots": o([
        { json: "background", js: "background", typ: "" },
        { json: "backgroundSelected", js: "backgroundSelected", typ: "" },
        { json: "backgroundOxygenLight", js: "backgroundOxygenLight", typ: "" },
        { json: "backgroundSelectedOxygenLight", js: "backgroundSelectedOxygenLight", typ: "" },
    ], false),
    "OxygenStatus": o([
    ...
    "OxygenText": o([
        ...
        { json: "textOxygenLinkInverseHover", js: "textOxygenLinkInverseHover", typ: "" },
        { json: "textOxygenLinkInverseActive", js: "textOxygenLinkInverseActive", typ: "" },
        { json: "textOxygenLinkNavigation", js: "textOxygenLinkNavigation", typ: "" },
        { json: "textOxygenLinkNavigationHover", js: "textOxygenLinkNavigationHover", typ: "" },
    ...
    "OxygenPage": o([
        { json: "shell", js: "shell", typ: r("OxygenShell") },
        { json: "container", js: "container", typ: r("OxygenContainer") },
    ], false),
    "OxygenContainer": o([
        { json: "padding", js: "padding", typ: r("OxygenPadding") },
    ], false),
    "OxygenPadding": o([
        { json: "inline", js: "inline", typ: "" },
    ], false),
    "OxygenShell": o([
        { json: "max", js: "max", typ: r("OxygenMax") },
    ], false),
    "OxygenMax": o([
        { json: "content", js: "content", typ: r("OxygenContent") },
    ], false),
    "OxygenContent": o([
        { json: "width", js: "width", typ: "" },
    ], false),
    ...
    "OxygenTypography": o([
        ...
        { json: "fontWeightRegular", js: "fontWeightRegular", typ: r("FontWeightRegular") },
        ...
        { json: "textRegular", js: "textRegular", typ: r("OxygenFormElementLargeClass") },
        ...
        { json: "textLargeTall", js: "textLargeTall", typ: r("OxygenFormElementLargeClass") },
        { json: "textRegularTall", js: "textRegularTall", typ: r("OxygenFormElementLargeClass") },
        { json: "textMicroWide", js: "textMicroWide", typ: r("OxygenOxygenTextMicroWide") },
        { json: "formLabel", js: "formLabel", typ: r("OxygenFormElementLargeClass") },
        { json: "formOxygenErrorMessage", js: "formOxygenErrorMessage", typ: r("OxygenFormElementLargeClass") },
        { json: "formOxygenErrorMessageSmall", js: "formOxygenErrorMessageSmall", typ: r("OxygenFormElementLargeClass") },
        { json: "formElementLarge", js: "formElementLarge", typ: r("OxygenFormElementLargeClass") },
        { json: "formElement", js: "formElement", typ: r("OxygenFormElementLargeClass") },
        { json: "formElementSmall", js: "formElementSmall", typ: r("OxygenFormElementLargeClass") },
        ...
        { json: "navigation", js: "navigation", typ: r("OxygenFormElementLargeClass") },
        { json: "small", js: "small", typ: r("OxygenFormElementLargeClass") },
        { json: "textReduced", js: "textReduced", typ: r("OxygenFormElementLargeClass") },
        { json: "textLargeShort", js: "textLargeShort", typ: r("OxygenFormElementLargeClass") },
        { json: "textRegularShort", js: "textRegularShort", typ: r("OxygenFormElementLargeClass") },
        { json: "formInput", js: "formInput", typ: r("OxygenFormElementLargeClass") },
        { json: "button", js: "button", typ: r("OxygenFormElementLargeClass") },
        { json: "buttonSmall", js: "buttonSmall", typ: r("OxygenFormElementLargeClass") },
        { json: "buttonLarge", js: "buttonLarge", typ: r("OxygenFormElementLargeClass") },
        { json: "light", js: "light", typ: r("OxygenBold") },
        { json: "book", js: "book", typ: r("OxygenBold") },
        { json: "bold", js: "bold", typ: r("OxygenBold") },
    ], false),
    "OxygenBold": o([
        { json: "fontWeight", js: "fontWeight", typ: "" },
    ], false),
    ...
    "OxygenLabel3": o([
        ...
        { json: "@media (max-width: 743px)", js: "@media (max-width: 743px)", typ: u(undefined, r("MediaOxygenMaxWidth743Px")) },
    ], false),
    "MediaOxygenMaxWidth743Px": o([
        { json: "fontSize", js: "fontSize", typ: "" },
        { json: "letterSpacing", js: "letterSpacing", typ: r("FontWeightRegular") },
        { json: "lineHeight", js: "lineHeight", typ: "" },
    ], false),
