...
const typeMap: any = {
  ...
  OxygenPalette: o(
    [
      ...
      { json: 'toggleButton', js: 'toggleButton', typ: r('OxygenToggleButton') },
      {
        ...
        typ: r('OxygenOxygenPageIndicatorDots'),
      },
      ...
      {
        json: 'SnackbarOxygenContent',
        js: 'SnackbarOxygenContent',
        typ: r('OxygenSkeleton'),
      },
      {
      ...
      {
        json: 'StepOxygenContent',
        js: 'StepOxygenContent',
        typ: r('OxygenStepConnector'),
      },
  ...
  OxygenPadding: o([{ json: 'inline', js: 'inline', typ: '' }], false),
  OxygenShell: o([{ json: 'max', js: 'max', typ: r('OxygenMax') }], false),
  OxygenMax: o([{ json: 'content', js: 'content', typ: r('OxygenContent') }], false),
  OxygenContent: o([{ json: 'width', js: 'width', typ: '' }], false),
  OxygenTransitions: o(
    [
  ...
  OxygenLabel3: o(
    [
      ...
      { json: 'paddingBottom', js: 'paddingBottom', typ: '' },
      {
        ...
        typ: u(undefined, r('MediaOxygenMaxWidth743Px')),
      },
    ],
    false
  ),
