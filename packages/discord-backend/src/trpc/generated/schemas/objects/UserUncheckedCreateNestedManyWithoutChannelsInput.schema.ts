...
const Schema: z.ZodType<Prisma.UserUncheckedCreateNestedManyWithoutChannelsInput> =
  z
    .object({
      create: z
        .union([
...
export const UserUncheckedCreateNestedManyWithoutChannelsInputObjectSchema =
  Schema;
