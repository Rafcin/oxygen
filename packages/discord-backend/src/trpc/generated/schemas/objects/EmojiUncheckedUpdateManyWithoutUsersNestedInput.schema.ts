...
const Schema: z.ZodType<Prisma.EmojiUncheckedUpdateManyWithoutUsersNestedInput> =
  z
    .object({
      create: z
        .union([
          ...
          z
            .lazy(() => EmojiUncheckedCreateWithoutUsersInputObjectSchema)
            .array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          ...
          z
            .lazy(() => EmojiCreateOrConnectWithoutUsersInputObjectSchema)
            .array(),
        ])
        .optional(),
      upsert: z
...
export const EmojiUncheckedUpdateManyWithoutUsersNestedInputObjectSchema =
  Schema;
