...
const Schema: z.ZodType<Prisma.MessageUncheckedCreateWithoutReactionsInput> = z
  .object({
    id: z.string(),
    thread: z.boolean(),
    channel_id: z.string(),
...
export const MessageUncheckedCreateWithoutReactionsInputObjectSchema = Schema;
