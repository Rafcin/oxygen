...
import { UserUpdateManyWithoutEmojisNestedInputObjectSchema } from './UserUpdateManyWithoutEmojisNestedInput.schema';
...
const Schema: z.ZodType<Prisma.EmojiUpdateWithoutGuildInput> = z
  .object({
    name: z
      .union([
        z.string(),
    ...
    roles: z
      ...
      .optional(),
    users: z
      .lazy(() => UserUpdateManyWithoutEmojisNestedInputObjectSchema)
      .optional(),
    userIds: z
      .union([
...
export const EmojiUpdateWithoutGuildInputObjectSchema = Schema;
