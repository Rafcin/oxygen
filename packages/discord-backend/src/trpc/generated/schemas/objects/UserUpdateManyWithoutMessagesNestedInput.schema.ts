...
const Schema: z.ZodType<Prisma.UserUpdateManyWithoutMessagesNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => UserUpsertWithWhereUniqueWithoutMessagesInputObjectSchema),
        z
          .lazy(() => UserUpsertWithWhereUniqueWithoutMessagesInputObjectSchema)
          .array(),
      ])
      .optional(),
    set: z
    ...
    update: z
      .union([
        z.lazy(() => UserUpdateWithWhereUniqueWithoutMessagesInputObjectSchema),
        z
          .lazy(() => UserUpdateWithWhereUniqueWithoutMessagesInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const UserUpdateManyWithoutMessagesNestedInputObjectSchema = Schema;
