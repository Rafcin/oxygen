...
const Schema: z.ZodType<Prisma.MessageUncheckedUpdateManyWithoutUsersNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => MessageUpsertWithWhereUniqueWithoutUsersInputObjectSchema,
          ),
          z
            .lazy(
              () => MessageUpsertWithWhereUniqueWithoutUsersInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => MessageUpdateWithWhereUniqueWithoutUsersInputObjectSchema,
          ),
          z
            .lazy(
              () => MessageUpdateWithWhereUniqueWithoutUsersInputObjectSchema,
...
export const MessageUncheckedUpdateManyWithoutUsersNestedInputObjectSchema =
  Schema;
