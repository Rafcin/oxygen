...
const Schema: z.ZodType<Prisma.GuildUpdateManyWithoutChannelsNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => GuildUpdateManyWithWhereWithoutChannelsInputObjectSchema),
        z
          .lazy(() => GuildUpdateManyWithWhereWithoutChannelsInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const GuildUpdateManyWithoutChannelsNestedInputObjectSchema = Schema;
