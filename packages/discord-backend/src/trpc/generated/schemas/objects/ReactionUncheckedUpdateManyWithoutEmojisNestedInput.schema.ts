...
const Schema: z.ZodType<Prisma.ReactionUncheckedUpdateManyWithoutEmojisNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => ReactionUpdateManyWithWhereWithoutEmojisInputObjectSchema,
          ),
          z
            .lazy(
              () => ReactionUpdateManyWithWhereWithoutEmojisInputObjectSchema,
...
export const ReactionUncheckedUpdateManyWithoutEmojisNestedInputObjectSchema =
  Schema;
