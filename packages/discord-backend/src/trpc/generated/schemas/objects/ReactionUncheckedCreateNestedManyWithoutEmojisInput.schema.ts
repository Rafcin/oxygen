...
const Schema: z.ZodType<Prisma.ReactionUncheckedCreateNestedManyWithoutEmojisInput> =
  z
    .object({
      create: z
        .union([
...
export const ReactionUncheckedCreateNestedManyWithoutEmojisInputObjectSchema =
  Schema;
