...
const Schema: z.ZodType<Prisma.ChannelUpdateManyWithWhereWithoutUsersInput> = z
  .object({
...
export const ChannelUpdateManyWithWhereWithoutUsersInputObjectSchema = Schema;
