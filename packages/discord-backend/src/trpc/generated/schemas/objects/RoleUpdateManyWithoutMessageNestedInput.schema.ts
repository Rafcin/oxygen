...
const Schema: z.ZodType<Prisma.RoleUpdateManyWithoutMessageNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => RoleUpsertWithWhereUniqueWithoutMessageInputObjectSchema),
        z
          .lazy(() => RoleUpsertWithWhereUniqueWithoutMessageInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => RoleUpdateWithWhereUniqueWithoutMessageInputObjectSchema),
        z
          .lazy(() => RoleUpdateWithWhereUniqueWithoutMessageInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const RoleUpdateManyWithoutMessageNestedInputObjectSchema = Schema;
