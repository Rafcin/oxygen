...
const Schema: z.ZodType<Prisma.MessageUpdateManyWithoutChannelsNestedInput> = z
  .object({
    create: z
      .union([
...
export const MessageUpdateManyWithoutChannelsNestedInputObjectSchema = Schema;
