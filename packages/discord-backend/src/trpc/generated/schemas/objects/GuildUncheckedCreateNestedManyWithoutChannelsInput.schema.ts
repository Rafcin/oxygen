...
const Schema: z.ZodType<Prisma.GuildUncheckedCreateNestedManyWithoutChannelsInput> =
  z
    .object({
      create: z
        .union([
...
export const GuildUncheckedCreateNestedManyWithoutChannelsInputObjectSchema =
  Schema;
