...
const Schema: z.ZodType<Prisma.UserUpdateManyWithoutChannelsNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => UserUpsertWithWhereUniqueWithoutChannelsInputObjectSchema),
        z
          .lazy(() => UserUpsertWithWhereUniqueWithoutChannelsInputObjectSchema)
          .array(),
      ])
      .optional(),
    set: z
    ...
    update: z
      .union([
        z.lazy(() => UserUpdateWithWhereUniqueWithoutChannelsInputObjectSchema),
        z
          .lazy(() => UserUpdateWithWhereUniqueWithoutChannelsInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const UserUpdateManyWithoutChannelsNestedInputObjectSchema = Schema;
