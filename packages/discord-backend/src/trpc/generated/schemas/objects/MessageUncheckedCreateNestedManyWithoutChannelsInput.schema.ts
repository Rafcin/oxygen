...
const Schema: z.ZodType<Prisma.MessageUncheckedCreateNestedManyWithoutChannelsInput> =
  z
    .object({
      create: z
        .union([
...
export const MessageUncheckedCreateNestedManyWithoutChannelsInputObjectSchema =
  Schema;
