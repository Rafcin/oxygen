...
const Schema: z.ZodType<Prisma.ChannelUpdateManyWithoutMessageNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => ChannelUpdateManyWithWhereWithoutMessageInputObjectSchema),
        z
          .lazy(() => ChannelUpdateManyWithWhereWithoutMessageInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const ChannelUpdateManyWithoutMessageNestedInputObjectSchema = Schema;
