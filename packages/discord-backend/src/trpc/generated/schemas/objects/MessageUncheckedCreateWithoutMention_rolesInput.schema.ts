...
const Schema: z.ZodType<Prisma.MessageUncheckedCreateWithoutMention_rolesInput> =
  z
    .object({
      id: z.string(),
      thread: z.boolean(),
      ...
      users: z
        .lazy(
          () => UserUncheckedCreateNestedManyWithoutMessagesInputObjectSchema,
        )
        .optional(),
      userIds: z
        .union([
...
export const MessageUncheckedCreateWithoutMention_rolesInputObjectSchema =
  Schema;
