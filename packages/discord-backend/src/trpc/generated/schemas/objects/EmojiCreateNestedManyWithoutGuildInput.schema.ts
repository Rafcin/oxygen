...
const Schema: z.ZodType<Prisma.EmojiCreateNestedManyWithoutGuildInput> = z
  .object({
    create: z
      .union([
        ...
        z.lazy(() => EmojiUncheckedCreateWithoutGuildInputObjectSchema).array(),
      ])
      .optional(),
    connectOrCreate: z
      .union([
        z.lazy(() => EmojiCreateOrConnectWithoutGuildInputObjectSchema),
        z.lazy(() => EmojiCreateOrConnectWithoutGuildInputObjectSchema).array(),
      ])
      .optional(),
    createMany: z
...
export const EmojiCreateNestedManyWithoutGuildInputObjectSchema = Schema;
