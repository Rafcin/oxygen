...
import { EmojiUpdateManyWithoutGuildNestedInputObjectSchema } from './EmojiUpdateManyWithoutGuildNestedInput.schema';
...
const Schema: z.ZodType<Prisma.GuildUpdateWithoutChannelsInput> = z
  .object({
    name: z
      .union([
        z.string(),
    ...
    roles: z
      ...
      .optional(),
    emojis: z
      .lazy(() => EmojiUpdateManyWithoutGuildNestedInputObjectSchema)
      .optional(),
    features: z
      .union([
...
export const GuildUpdateWithoutChannelsInputObjectSchema = Schema;
