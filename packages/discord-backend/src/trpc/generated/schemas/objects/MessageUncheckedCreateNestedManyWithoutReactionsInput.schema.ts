...
const Schema: z.ZodType<Prisma.MessageUncheckedCreateNestedManyWithoutReactionsInput> =
  z
    .object({
      create: z
        .union([
...
export const MessageUncheckedCreateNestedManyWithoutReactionsInputObjectSchema =
  Schema;
