...
const Schema: z.ZodType<Prisma.ReactionUpdateManyWithoutMessagesNestedInput> = z
  .object({
    create: z
      .union([
...
export const ReactionUpdateManyWithoutMessagesNestedInputObjectSchema = Schema;
