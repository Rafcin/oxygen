...
const Schema: z.ZodType<Prisma.ChannelUpdateManyWithoutGuildsNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => ChannelUpdateManyWithWhereWithoutGuildsInputObjectSchema),
        z
          .lazy(() => ChannelUpdateManyWithWhereWithoutGuildsInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const ChannelUpdateManyWithoutGuildsNestedInputObjectSchema = Schema;
