...
const Schema: z.ZodType<Prisma.UserUpdateManyWithWhereWithoutMessagesInput> = z
  .object({
...
export const UserUpdateManyWithWhereWithoutMessagesInputObjectSchema = Schema;
