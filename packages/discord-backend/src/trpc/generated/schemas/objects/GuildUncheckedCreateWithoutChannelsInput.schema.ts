...
import { UserUncheckedCreateNestedManyWithoutGuildsInputObjectSchema } from './UserUncheckedCreateNestedManyWithoutGuildsInput.schema';
...
const Schema: z.ZodType<Prisma.GuildUncheckedCreateWithoutChannelsInput> = z
  .object({
    id: z.string(),
    name: z.string(),
    ...
    users: z
      .lazy(() => UserUncheckedCreateNestedManyWithoutGuildsInputObjectSchema)
      .optional(),
    userIds: z
      .union([
...
export const GuildUncheckedCreateWithoutChannelsInputObjectSchema = Schema;
