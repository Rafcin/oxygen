import { z } from 'zod';
import { GuildUncheckedCreateNestedManyWithoutChannelsInputObjectSchema } from './GuildUncheckedCreateNestedManyWithoutChannelsInput.schema';
...
const Schema: z.ZodType<Prisma.ChannelUncheckedCreateWithoutMessageInput> = z
  .object({
    id: z.string(),
    name: z.string(),
    channel_discord_type: z.number(),
    ...
    guilds: z
      .lazy(
        () => GuildUncheckedCreateNestedManyWithoutChannelsInputObjectSchema,
      )
      .optional(),
    guildIds: z
      .union([
...
export const ChannelUncheckedCreateWithoutMessageInputObjectSchema = Schema;
