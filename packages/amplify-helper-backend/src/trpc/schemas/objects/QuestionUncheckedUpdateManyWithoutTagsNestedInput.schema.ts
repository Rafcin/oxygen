...
const Schema: z.ZodType<Prisma.QuestionUncheckedUpdateManyWithoutTagsNestedInput> = z
  .object({
    create: z
      .union([
...
export const QuestionUncheckedUpdateManyWithoutTagsNestedInputObjectSchema = Schema
