...
const Schema: z.ZodType<Prisma.QuestionUncheckedUpdateWithoutGithubDiscussionInput> =
  z
    .object({
      id: z
        .union([
...
export const QuestionUncheckedUpdateWithoutGithubDiscussionInputObjectSchema = Schema
