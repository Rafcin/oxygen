...
const Schema: z.ZodType<Prisma.QuestionUncheckedUpdateWithoutParticipationInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const QuestionUncheckedUpdateWithoutParticipationInputObjectSchema = Schema
