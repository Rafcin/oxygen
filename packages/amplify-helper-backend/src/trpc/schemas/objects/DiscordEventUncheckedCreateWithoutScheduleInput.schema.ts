...
const Schema: z.ZodType<Prisma.DiscordEventUncheckedCreateWithoutScheduleInput> = z
  .object({
    id: z.string(),
    title: z.string(),
...
export const DiscordEventUncheckedCreateWithoutScheduleInputObjectSchema = Schema
