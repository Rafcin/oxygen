...
const Schema: z.ZodType<Prisma.AnswerUncheckedUpdateOneWithoutParticipationNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const AnswerUncheckedUpdateOneWithoutParticipationNestedInputObjectSchema =
  Schema
