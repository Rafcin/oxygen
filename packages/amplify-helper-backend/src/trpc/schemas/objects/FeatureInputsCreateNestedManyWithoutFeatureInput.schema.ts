...
const Schema: z.ZodType<Prisma.FeatureInputsCreateNestedManyWithoutFeatureInput> = z
  .object({
    create: z
      .union([
...
export const FeatureInputsCreateNestedManyWithoutFeatureInputObjectSchema = Schema
