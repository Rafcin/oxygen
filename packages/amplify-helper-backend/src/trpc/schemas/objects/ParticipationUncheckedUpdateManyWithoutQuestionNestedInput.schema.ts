...
const Schema: z.ZodType<Prisma.ParticipationUncheckedUpdateManyWithoutQuestionNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ParticipationUncheckedUpdateManyWithoutQuestionNestedInputObjectSchema =
  Schema
