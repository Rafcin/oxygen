...
const Schema: z.ZodType<Prisma.QuestionUncheckedCreateWithoutGithubDiscussionInput> =
  z
    .object({
...
export const QuestionUncheckedCreateWithoutGithubDiscussionInputObjectSchema = Schema
