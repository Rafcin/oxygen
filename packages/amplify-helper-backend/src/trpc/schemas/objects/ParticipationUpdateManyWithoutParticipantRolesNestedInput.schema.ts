...
const Schema: z.ZodType<Prisma.ParticipationUpdateManyWithoutParticipantRolesNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ParticipationUpdateManyWithoutParticipantRolesNestedInputObjectSchema =
  Schema
