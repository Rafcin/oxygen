...
const Schema: z.ZodType<Prisma.ConfigurationUpdateOneWithoutGuildNestedInput> = z
  .object({
    create: z
      .union([
...
export const ConfigurationUpdateOneWithoutGuildNestedInputObjectSchema = Schema
