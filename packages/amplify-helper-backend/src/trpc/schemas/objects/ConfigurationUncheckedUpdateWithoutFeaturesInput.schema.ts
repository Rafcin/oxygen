...
const Schema: z.ZodType<Prisma.ConfigurationUncheckedUpdateWithoutFeaturesInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const ConfigurationUncheckedUpdateWithoutFeaturesInputObjectSchema = Schema
