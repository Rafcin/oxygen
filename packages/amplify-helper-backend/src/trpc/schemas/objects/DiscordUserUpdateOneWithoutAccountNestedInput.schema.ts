...
const Schema: z.ZodType<Prisma.DiscordUserUpdateOneWithoutAccountNestedInput> = z
  .object({
    create: z
      .union([
...
export const DiscordUserUpdateOneWithoutAccountNestedInputObjectSchema = Schema
