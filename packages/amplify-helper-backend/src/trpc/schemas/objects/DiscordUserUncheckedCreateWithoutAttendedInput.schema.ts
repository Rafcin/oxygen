...
const Schema: z.ZodType<Prisma.DiscordUserUncheckedCreateWithoutAttendedInput> = z
  .object({
    id: z.string(),
...
export const DiscordUserUncheckedCreateWithoutAttendedInputObjectSchema = Schema
