...
const Schema: z.ZodType<Prisma.FeatureUncheckedCreateNestedManyWithoutTypeInput> = z
  .object({
    create: z
      .union([
...
export const FeatureUncheckedCreateNestedManyWithoutTypeInputObjectSchema = Schema
