...
const Schema: z.ZodType<Prisma.ParticipationUncheckedCreateNestedManyWithoutQuestionInput> =
  z
    .object({
      create: z
        .union([
...
export const ParticipationUncheckedCreateNestedManyWithoutQuestionInputObjectSchema =
  Schema
