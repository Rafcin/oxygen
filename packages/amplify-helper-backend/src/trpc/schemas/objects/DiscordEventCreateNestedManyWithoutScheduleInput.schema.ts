...
const Schema: z.ZodType<Prisma.DiscordEventCreateNestedManyWithoutScheduleInput> = z
  .object({
    create: z
      .union([
...
export const DiscordEventCreateNestedManyWithoutScheduleInputObjectSchema = Schema
