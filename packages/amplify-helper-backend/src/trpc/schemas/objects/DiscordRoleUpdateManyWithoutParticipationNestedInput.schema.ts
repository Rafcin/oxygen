...
const Schema: z.ZodType<Prisma.DiscordRoleUpdateManyWithoutParticipationNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const DiscordRoleUpdateManyWithoutParticipationNestedInputObjectSchema =
  Schema
