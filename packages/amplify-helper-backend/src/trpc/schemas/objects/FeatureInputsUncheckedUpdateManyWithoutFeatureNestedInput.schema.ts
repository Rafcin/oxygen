...
const Schema: z.ZodType<Prisma.FeatureInputsUncheckedUpdateManyWithoutFeatureNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const FeatureInputsUncheckedUpdateManyWithoutFeatureNestedInputObjectSchema =
  Schema
