...
const Schema: z.ZodType<Prisma.EventScheduleUncheckedCreateWithoutCreatedByInput> = z
  .object({
...
export const EventScheduleUncheckedCreateWithoutCreatedByInputObjectSchema = Schema
