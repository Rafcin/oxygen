...
const Schema: z.ZodType<Prisma.AnswerUncheckedUpdateOneWithoutQuestionNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const AnswerUncheckedUpdateOneWithoutQuestionNestedInputObjectSchema = Schema
