...
const Schema: z.ZodType<Prisma.DiscordEventUncheckedUpdateManyWithoutCreatedByNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const DiscordEventUncheckedUpdateManyWithoutCreatedByNestedInputObjectSchema =
  Schema
