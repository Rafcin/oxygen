...
const Schema: z.ZodType<Prisma.DiscordEventUncheckedUpdateWithoutCreatedByInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const DiscordEventUncheckedUpdateWithoutCreatedByInputObjectSchema = Schema
