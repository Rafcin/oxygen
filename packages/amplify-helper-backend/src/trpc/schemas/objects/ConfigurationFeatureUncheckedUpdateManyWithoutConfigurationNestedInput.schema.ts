...
const Schema: z.ZodType<Prisma.ConfigurationFeatureUncheckedUpdateManyWithoutConfigurationNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ConfigurationFeatureUncheckedUpdateManyWithoutConfigurationNestedInputObjectSchema =
  Schema
