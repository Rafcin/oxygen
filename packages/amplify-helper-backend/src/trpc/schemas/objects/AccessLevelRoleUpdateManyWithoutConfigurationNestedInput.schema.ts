...
const Schema: z.ZodType<Prisma.AccessLevelRoleUpdateManyWithoutConfigurationNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const AccessLevelRoleUpdateManyWithoutConfigurationNestedInputObjectSchema =
  Schema
