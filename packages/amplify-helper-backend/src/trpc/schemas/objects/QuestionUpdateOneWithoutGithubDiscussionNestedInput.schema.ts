...
const Schema: z.ZodType<Prisma.QuestionUpdateOneWithoutGithubDiscussionNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const QuestionUpdateOneWithoutGithubDiscussionNestedInputObjectSchema = Schema
