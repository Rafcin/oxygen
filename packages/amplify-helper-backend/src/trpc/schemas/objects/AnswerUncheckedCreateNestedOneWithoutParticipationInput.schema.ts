...
const Schema: z.ZodType<Prisma.AnswerUncheckedCreateNestedOneWithoutParticipationInput> =
  z
    .object({
      create: z
        .union([
...
export const AnswerUncheckedCreateNestedOneWithoutParticipationInputObjectSchema =
  Schema
