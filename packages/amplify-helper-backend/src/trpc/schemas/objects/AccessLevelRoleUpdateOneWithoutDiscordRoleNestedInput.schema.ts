...
const Schema: z.ZodType<Prisma.AccessLevelRoleUpdateOneWithoutDiscordRoleNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const AccessLevelRoleUpdateOneWithoutDiscordRoleNestedInputObjectSchema =
  Schema
