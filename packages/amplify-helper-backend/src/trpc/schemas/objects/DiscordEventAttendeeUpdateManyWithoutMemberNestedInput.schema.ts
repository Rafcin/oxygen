...
const Schema: z.ZodType<Prisma.DiscordEventAttendeeUpdateManyWithoutMemberNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const DiscordEventAttendeeUpdateManyWithoutMemberNestedInputObjectSchema =
  Schema
