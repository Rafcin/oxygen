    ...
    return (
      <Html lang="en">
        <Head>
          ...
          <meta name="application-name" content="shanks.tv" />
          <meta
            name="description"
            content="Shanks is a streaming application for Anime and a e-reader for Manga."
          />

          <meta name="apple-mobile-web-app-title" content="shanks.tv" />
          <meta
