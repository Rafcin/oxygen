...
const Home = () => {
  ...
  const maps = api.maps.textSearch.useQuery(
    {
      location: {
  ...
  const details = api.maps.detailSearch.useMutation()
          ...
          <form>
            ...
            >
              ...
              <Container maxWidth="md">
                ...
                <FormHelperText>
                  Use this field to change the query type. For example, if you want
                  to find sushi places then type "Sushi" or "Sushi Restaurants" or
                ...
                <FormHelperText>
                  ...
                  location on the map to search in just type the city, address,
                  zipcode, state or country.
                </FormHelperText>
                <br />
                <Button
                  endIcon={<FaFileCsv />}
                ...
                <FormHelperText>
                  ...
                  dataset. Once you have selected the locations you want to add to
                  your dataset, click the button below to continue.
                </FormHelperText>
              </Container>
            </Paper>
            <Paper
