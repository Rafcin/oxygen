    ...
    return (
      <Html lang="en">
        <Head>
          ...
          <meta name="application-name" content="robin.rafszuminski.com" />
          <meta
            name="description"
            content="Robin is a streaming application for Anime and a e-reader for Manga."
          />

          <meta name="apple-mobile-web-app-title" content="robin.rafszuminski.com" />
